...
class TopHeadlinesTableViewController: UIViewController {
...
extension TopHeadlinesTableViewController: UITableViewDelegate, UITableViewDataSource, UISearchBarDelegate{
